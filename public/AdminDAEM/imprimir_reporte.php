...
<head>
    ...
    <style>
        ...
        /* ESTILO PARA LA ALERTA DE LÍMITE */
        .alerta-limite {
        ...
        .text-warning { color: #ffc107; font-weight: bold; text-shadow: 0px 0px 1px #997404; } /* Sombra para que se lea en blanco */
...
<body onload="window.print()">
    ...
    <?php if ($total_mostrados >= 500): ?>
        <div class="alerta-limite">
            ...
            Por seguridad y rendimiento, este PDF solo muestra los primeros <strong>500 registros</strong>.<br>
            Si necesita el listado completo, por favor utilice la opción <strong>"Exportar Excel"</strong> en el sistema.
        </div>
    <?php else: ?>
